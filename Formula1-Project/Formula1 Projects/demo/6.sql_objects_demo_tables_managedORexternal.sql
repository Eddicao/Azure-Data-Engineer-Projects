...
-- MAGIC ### create a data frame from PARQUET file from Datalake - presentation container
...
--- query data by using SQL queries
...
-- MAGIC
-- MAGIC ## create External  table using Python - race_results_ext_py
...
---- ## create EXTERNAL table using SQL  => this create METADATA in META STORE - to have table in demo - Hive storage
/***
CREATE TABLE demo.race_results_sql
AS
SELECT *
...
--- create External  table using Python - race_results_ext_sql
...
--- create view from tables in demo database // not from dataframes
